<template>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                    <div v-if="EmLeave.isRequestLoading" class="overlay">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button @click="EmLeave.setComponentTo('leave-request-component')" class="btn btn-danger btn-sm">
...
export default defineComponent({
    setup() {
        ...
        const submitRequest = async () => {
            await EmLeave.addEmployeeLeaveRequest(form);
            await EmLeave.setComponentTo('leave-request-component');
            toastr.info('Leave added.');
        }
