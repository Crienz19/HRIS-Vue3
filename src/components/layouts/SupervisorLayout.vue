<template>
    ...
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
            ...
            <li class="nav-item">
                <router-link to="/sv/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/leaves') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/sv/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/overtimes') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/sv/trips" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/trips') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/sv/coe" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/coe') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/sv/subs/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/subs/leaves') ? 'active' : ''">
                    <i class="nav-icon fas fa-scroll"></i>
                    <p>
                    Leaves
                    </p>
            ...
            <li class="nav-item">
                <router-link to="/sv/subs/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/sv/subs/overtimes') ? 'active' : ''">
                    <i class="nav-icon fas fa-scroll"></i>
                    <p>
                    Overtime
                    </p>
