    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    <router-link tag="a" to="/ad/dashboard" class="nav-link" :class="(router.currentRoute.value.path === '/em/dashboard') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/ad/e/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/e/leaves') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/ad/e/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/e/overtimes') ? 'active' : ''">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>
                        Overtime
                        </p>
                ...
                <li class="nav-item">
                    <router-link to="/ad/e/trips" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/e/trips') ? 'active' : ''">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>
                        Business Trips
                        </p>
                ...
                <li class="nav-item">
                    <router-link to="/ad/s/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/s/leaves') ? 'active' : ''">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>
                        Leaves
                        </p>
                ...
                <li class="nav-item">
                    <router-link to="/ad/s/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/s/overtimes') ? 'active' : ''">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>
                        Overtime
                        </p>
                ...
                <li class="nav-item">
                    <router-link to="/ad/s/trips" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/ad/s/trips') ? 'active' : ''">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>
                        Business Trips
                        </p>
