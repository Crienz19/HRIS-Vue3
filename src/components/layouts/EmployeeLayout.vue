<template>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info text-capitalized">
                {{ user.name }}
            </div>
        </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
            ...
            <li class="nav-item">
                <router-link tag="a" to="/em/dashboard" class="nav-link" :class="(router.currentRoute.value.path === '/em/dashboard') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/em/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/em/leaves') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/em/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/em/overtimes') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/em/trips" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/em/trips') ? 'active' : ''">
            ...
            <li class="nav-item">
                <router-link to="/em/coe" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/em/coe') ? 'active' : ''">
