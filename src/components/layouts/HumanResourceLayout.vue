    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    <router-link tag="a" to="/hr/dashboard" class="nav-link" :class="(router.currentRoute.value.path === '/hr/dashboard') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/hr/leaves" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/hr/leaves') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/hr/overtimes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/hr/overtimes') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/hr/trips" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/hr/trips') ? 'active' : ''">
                ...
                <li class="nav-item">
                    <router-link to="/hr/coes" tag="a" class="nav-link" :class="(router.currentRoute.value.path === '/hr/coes') ? 'active' : ''">
                        <i class="nav-icon fas fa-business-time"></i>
                        <p>
                        COE Requests
                        </p>
